app.factory('jsPdfBuilder', function ($ionicLoading, $cordovaFile, formInfo) {
    ...
    function Signatures () {      
        ...
        for (var i=0; i < formInfo.signatures.length;i++) {
           if (i==0) {
               doc.text(column1, 195, formInfo.signatures[0].name);
               doc.text(column4, 190, formInfo.signatures[0].date.toString());
               //doc.text(column3, row1,signatures[0].tb_AtRisk);
               //doc.addImage(formInfo.signatures[0].signature, 'JPEG', column2, row1, 60, 4);
           }
           //if (i==1) {
           ...
           //    //doc.addImage(signImage, 'JPEG', column2, 100.5, 100, 100);
           //}
           //if (i==2) {
           //    doc.text(column1,row3, formInfo.signatures[2].name);
           //    doc.text(column4,row3, formInfo.signatures[2].date);
